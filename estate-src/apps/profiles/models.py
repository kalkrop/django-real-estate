...
class Profile(TimeStampedUUIDModel):
    ...
    about_number = models.TextField(verbose_name=_("About me"), default="Say something about yourself")
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Brasília", blank=False, null=False)
    ...
    is_agent = models.BooleanField(verbose_name=_("Agente"), default=False, help_text=_("Are you an agent?"))
